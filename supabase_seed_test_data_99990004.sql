-- ============================================================
-- Seed test data for parent mobile: 99990004
-- Email: colin.wong@hkedutech.com
--
-- What this script does:
-- 1) Creates/updates parent 99990004
...
--
-- Safe to rerun:
-- - Existing students under parent 99990004 are removed first
...
VALUES ('99990004', 'colin.wong@hkedutech.com', 'Test Parent 99990004')
...
BEGIN
  SELECT count(*) INTO v_school_count FROM tmp_seed_99990004_schools;
...
student_plan AS (
  ...
  FROM parent_row p
  CROSS JOIN tmp_seed_99990004_schools sch
...
assigned_sessions AS (
  SELECT
    ...
    ('seed-99990004-' || lower(sp.subject) || '-' || gen_random_uuid()::TEXT) AS session_token
...
FROM tmp_seed_99990004_schools
ORDER BY district;
...
WHERE p.mobile_number = '99990004'
