-- Batch 2/3 (Set 3): English sessions + answers (200)
BEGIN;

DELETE FROM public.session_answers sa
USING public.quiz_sessions qs
WHERE sa.session_id = qs.id
  AND qs.session_token LIKE 'gearup_seed_99990012_english_%';

DELETE FROM public.quiz_sessions
WHERE session_token LIKE 'gearup_seed_99990012_english_%';
...
ins_sessions AS (
  ...
  SELECT
    ...
    'gearup_seed_99990012_english_' || gen_random_uuid()::text,
    NULL
