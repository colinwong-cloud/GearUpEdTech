  ...
  features: [
    ...
    },
    {
      ...
      checks: [
        ...
        { type: "file_contains", path: "src/lib/session-practice-summary.ts", snippet: "今次正確率有" },
        { type: "file_contains", path: "src/lib/session-practice-summary.ts", snippet: "題型既" },
        { type: "file_contains", path: "src/lib/session-practice-summary.ts", snippet: "想一想" },
    ...
    },
    {
      ...
      checks: [
        ...
        { type: "file_contains", path: "src/app/mer/page.tsx", snippet: "Search vendors" },
        { type: "file_contains", path: "src/app/mer/page.tsx", snippet: "Vendor PO number" },
        { type: "file_contains", path: "src/lib/server/merchant-documents.ts", snippet: "P.O.#" },
        { type: "file_exists", path: "public/mer/gearup-stamp.png" },
        { type: "file_contains", path: "src/app/mer/page.tsx", snippet: "BILL TO" },
        { type: "file_contains", path: "src/lib/server/merchant-logic.ts", snippet: "cs@gearupquiz.com" },
        { type: "file_exists", path: "supabase_merchant_invoice_po.sql" },
        { type: "file_contains", path: "src/app/mer/page.tsx", snippet: "Cheque number" },
        { type: "file_contains", path: "src/app/mer/page.tsx", snippet: "Bank transfer" },
        ...
        { type: "file_contains", path: "src/lib/server/merchant-logic.ts", snippet: "Net 90" },
        { type: "file_contains", path: "src/app/mer/page.tsx", snippet: "Leave blank" },
        { type: "file_exists", path: "supabase_merchant_payment_terms.sql" },
